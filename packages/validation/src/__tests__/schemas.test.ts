...
describe('customDomainSchema', () => {
  it('should accept valid domains', () => {
    expect(customDomainSchema.parse('mitienda.com.uy')).toEqual(
      'mitienda.com.uy',
    )
    expect(customDomainSchema.parse('www.tienda.com')).toEqual('www.tienda.com')
    expect(customDomainSchema.parse('shop.example.org')).toEqual(
      'shop.example.org',
    )
  })
...
describe('addCartItemSchema', () => {
  ...
  it('should reject quantity less than 1', () => {
    expect(() =>
      addCartItemSchema.parse({ variantId: 'v1', quantity: 0 }),
    ).toThrow()
  })
})
...
describe('checkoutPreferenceSchema', () => {
  ...
  it('should reject invalid email', () => {
    expect(() =>
      checkoutPreferenceSchema.parse({
        orderId: 'o1',
