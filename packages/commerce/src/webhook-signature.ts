...
function parseSignatureHeader(header: string): { wellFormed: boolean; ts?: string; v1?: string } {
...
export function verifyMercadoPagoSignature(
  ...
  if (parsed.ts === undefined || parsed.ts === "") return { valid: false, reason: "missing-ts" };
  if (parsed.v1 === undefined || parsed.v1 === "") return { valid: false, reason: "missing-parts" };
