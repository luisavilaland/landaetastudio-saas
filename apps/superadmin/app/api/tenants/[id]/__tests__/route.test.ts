...
describe('GET /api/tenants/[id] — Role Check', () => {
  ...
  it('should return 403 when user is not superadmin', async () => {
    ...
    const params: Parameters<typeof GET>[1] = {
      params: Promise.resolve({ id: 'test-tenant-id' }),
    }
...
describe('DELETE /api/tenants/[id] — Role Check', () => {
  ...
  it('should return 403 when user is not superadmin', async () => {
    ...
    const params: Parameters<typeof DELETE>[1] = {
      params: Promise.resolve({ id: 'test-tenant-id' }),
    }
...
describe('PUT /api/tenants/[id]', () => {
  ...
  it('should update customDomain with valid domain', async () => {
    ...
    const res = await makePUTRequest('test-tenant-id', {
      customDomain: 'mitienda.com.uy',
    })
  ...
  it('should reject invalid domain format', async () => {
    const res = await makePUTRequest('test-tenant-id', {
      customDomain: 'http://mitienda.com',
    })
