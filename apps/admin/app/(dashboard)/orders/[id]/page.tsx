    ...
    <div style={{ padding: '2rem', maxWidth: 800 }}>
      ...
      {order.shippingDetails && (
        ...
        >
          ...
          <p>
            <strong>Nombre:</strong> {order.shippingDetails.name || '-'}
          </p>
          <p>
            <strong>Email:</strong>{' '}
            {order.shippingDetails.email || order.customerEmail || '-'}
          </p>
          <p>
            <strong>Teléfono:</strong> {order.shippingDetails.phone || '-'}
          </p>
          <p>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ borderBottom: '2px solid #e5e5e5' }}>
              <th
                style={{ textAlign: 'left', padding: '0.5rem', color: '#666' }}
              >
                Producto
              </th>
              <th
              ...
              <th
                style={{ textAlign: 'right', padding: '0.5rem', color: '#666' }}
              >
                Cantidad
              </th>
              <th
