...
export default function DashboardPage() {
  ...
  return (
    <div style={{ padding: '2rem' }}>
        ...
        >
          ...
          <p
            style={{
              ...
              fontWeight: 'bold',
              color:
                (metrics?.lowStockProducts || 0) > 0 ? '#d97706' : 'inherit',
            }}
          >
        ...
        >
          ...
          <p
            style={{
              ...
              fontWeight: 'bold',
              color:
                (metrics?.outOfStockProducts || 0) > 0 ? '#dc2626' : 'inherit',
            }}
          >
      ...
      {!metrics?.recentOrders || metrics.recentOrders.length === 0 ? (
        ...
        >
          <thead>
            ...
            >
              <th
                style={{ textAlign: 'left', padding: '0.75rem', color: '#666' }}
              >
                ID
              </th>
              <th
      ...
      metrics.lowStockProductsList.length === 0 ? null : (
        <>
          <h2
            style={{
              fontSize: '1.25rem',
